        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    __setKeymap('grr', builtin.lsp_references, { buffer = buf, desc = 'LSP: [rr]eferences' })

                    -- Jump to the implementation of the word under your cursor.
                    --  Useful when your language has ways of declaring types without an actual implementation.
                    __setKeymap('gri', builtin.lsp_implementations, { buffer = buf, desc = 'LSP: [r]ead [i]mplementation(s)' })

                    -- Jump to the definition of the word under your cursor.
                    --  This is where a variable was first declared, or where a function is defined, etc.
                    --  To jump back, press <C-t>.
                    __setKeymap('grd', builtin.lsp_definitions, { buffer = buf, desc = 'LSP: [r]ead [d]efinition' })

                    -- Fuzzy find all the symbols in your current document.
                    --  Symbols are things like variables, functions, types, etc.
                    __setKeymap('gO', builtin.lsp_document_symbols, { buffer = buf, desc = 'LSP: [O]pen Document Symbols' })

                    -- Fuzzy find all the symbols in your current workspace
                    --  Similar to document symbols, except searches over your whole project.
                    __setKeymap('gW', builtin.lsp_dynamic_workspace_symbols, { buffer = buf, desc = 'LSP: Open [W]orkspace Symbols' })

                    -- Jump to the type of the word under your cursor.
                    --  Useful when you're not sure what type a variable is and you want to see
                    --  the definition of its *type*, not where it was *defined*.
                    __setKeymap('grt', builtin.lsp_type_definitions, { buffer = buf, desc = 'LSP: [r]ead [t]ype Definition' })
                end,
            })
        end,
    },
